...
assign ad_out0 = ad_hold_0 ^ ((ad_neg[0])?12'hFFF:0);
assign ad_out1 = ad_hold_1 ^ ((ad_neg[1])?12'hFFF:0);
assign ad_out2 = ad_hold_2 ^ ((ad_neg[2])?12'hFFF:0);
assign ad_out3 = ad_hold_3 ^ ((ad_neg[3])?12'hFFF:0);
